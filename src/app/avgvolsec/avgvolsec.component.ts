...
@Component({
  selector: 'app-avgvolsec',
  templateUrl: './avgvolsec.component.html',
  styleUrls: ['./avgvolsec.component.css']
})
export class AvgvolsecComponent implements OnInit {
  ...
  callGetData(){
    ...
    this.v = this.getval()
    this._dataService.getDataVolSec(this.v)
      .subscribe(data => 
        {this.data = data;
        console.log(data);
        });
  ...
  dis(value) {
    ...
    var myDemo = document.getElementById('demovolsec');
